...
public class Programforcalculations extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Programforcalculations frame = new Programforcalculations();
	 ...
	 * Create the frame.
	 */
	public Programforcalculations() {
		setTitle(
				"\u041F\u0440\u043E\u0433\u0440\u0430\u043C\u0430 \u0437\u0430 \u0438\u0437\u0447\u0438\u0441\u043B\u0435\u043D\u0438\u044F");
		...
		rbtnline = new JRadioButton(
				"\u041B\u0438\u043D\u0435\u0439\u043D\u043E \u0443\u0440\u0430\u0432\u043D\u0435\u043D\u0438\u0435");
		rbtnline.setBackground(Color.WHITE);
		...
		rbtnsqare = new JRadioButton(
				"\u041A\u0432\u0430\u0434\u0440\u0430\u0442\u043D\u043E \u0443\u0440\u0430\u0432\u043D\u0435\u043D\u0438\u0435");
		rbtnsqare.setBackground(Color.WHITE);
		...
		rbtnbisqare.setBackground(Color.WHITE);
		...
		btncalculate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				for(int xlines=0;xlines<=71;xlines++) {
					g.drawLine(xlines*5, 0, xlines*5, 350);
				}
				for(int ylines=0;ylines<=71;ylines++) {
					g.drawLine(0, ylines*5, 350, ylines*5);
				}
				...
				if (calculations == 3) {
					if (txta.getText().isEmpty()) {
						...
						if (Double.parseDouble(txta.getText()) != 0) {
							...
							is_a_typed = false;
							result += "0 in not a valid value for a!";
							lblresult.setText(result);
						}
					...
					if (is_a_typed == true & is_b_typed == true & is_zoom_typed == true) {
						...
						if (a != 0 & b != 0 & c == 0) {
							if (a * b < 0) {
								result = "x1=0;" + "x2=" + Math.sqrt(-b / a) + ";x3=" + -Math.sqrt(-b / a);
								lblresult.setText(result);
							} else {
								result = "x1=0";
								lblresult.setText(result);
		...
		btncalculate.setBounds(49, 96, 390, 33);
		...
		lblsqare.setBounds(143, 37, 163, 33);
		...
		lblsqarefunction.setBackground(Color.BLACK);
		lblsqarefunction.setVisible(false);
		...
		pnlfunction.setBounds(71, 243, 351, 351);
		...
		btnclear.setBounds(347, 600, 103, 23);
		...
		txtzoom.setText("1");
		txtzoom.setBounds(119, 604, 60, 20);
		...
		lblzoom.setBounds(49, 604, 60, 14);
